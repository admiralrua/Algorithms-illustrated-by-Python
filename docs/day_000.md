...
```
We are referring to a fake footnote <sup>[1](#fn01)</sup> and another one <sup>[2](#fn02)</sup>. [^3]

<a name="fn01">1</a>: This is a fake footnote.

<a name="fn02">2</a>: This is another fake footnote.

[^3]: default is not working.
